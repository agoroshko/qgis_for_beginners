...
Для примеров используется программный продукт QGIS версии 3.28.10 LTR как наиболее стабильный и актуальный на данный момент. Его можно загрузить с официального сайта <https://qgis.org/ru/site/> Настоящее руководство можно использовать для выполнения заданий и в других версиях программы QGIS.  
